...
$_LANG['cp_home'] = '商网通 管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2008-2015 鹤翰网络，并保留所有权利。';
...
$_LANG['17_weixin_manage'] = '微信模块'; // 增加 by www.swtshop.cn 微商城
$_LANG['18_virtual'] = '虚拟团购管理';

/* 商品管理 */
/* 代码增加_start By supplier.swtshop.cn */
$_LANG['00_warehouse_list'] = '发货仓列表';
$_LANG['01_goods_list'] = '商品列表';
$_LANG['02_supplier_goods_list'] = '入驻商商品列表';
$_LANG['03_goods_add'] = '添加新商品';
$_LANG['04_category_list'] = '商品分类';
/* 代码增加_end By supplier.swtshop.cn */
...
$_LANG['price_batch'] = '批量修改价格'; // 代码增加 By www.swtshop.cn
$_LANG['article_auto'] = '文章自动发布';
$_LANG['navigator'] = '自定义导航栏';
/* 虚拟团购 代码增加 by www.swtshop.cn start */
...
/* 虚拟团购 代码增加 by www.swtshop.cn end */
...
$_LANG['04_users_export'] = '会员导出'; // 代码增加 By www.swtshop.cn
...
/* 代码增加_end By supplier.swtshop.cn */
// 微信管理 增加 start by www.swtshop.cn 微商城
...
$_LANG['06_goods_ware_list'] = '仓库列表';
$_LANG['07_ware_add'] = '添加仓库';
?>