...
$modules['02_cat_and_goods']['00_warehouse_list'] = 'ware.php?act=list'; // 发货仓列表
...
$modules['03_promotion']['26_Sales'] = 'Sales.php?act=edit&code=order_del';
...
/* 虚拟卷订单列表_添加_START_www.98ecshop.com */
...
/* 代码添加_START By www.98ecshop.com */
$modules['06_stats']['keyword'] = 'keyword.php?act=list';
/* 代码添加_SEND By www.98ecshop.com */
