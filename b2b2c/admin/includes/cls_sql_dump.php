...
class cls_sql_dump
{
     ...
     */
    public static function get_head($path)  //代码修改   By    www.98ecshop.com   增加 public static
    {
        /* 获取sql文件头部信息 */
     ...
     */
    public static function get_random_name()  //代码修改   By    www.98ecshop.com
    {
        $str = date('Ymd');
