...
/*增值税发票_添加_START_www.98ecshop.com*/
...
{
    /* 检查权限 */
    /*增值税发票_更改_START_www.98ecshop.com*/
...
file_put_contents('./3$_REQUEST3.txt',var_export($_REQUEST,true));
    ...
    elseif ('other' == $step)
    {
        ...
        /*增值税发票_删除_START_www.98ecshop.com*/
        //$order['inv_type']      = $_POST['inv_type'];
        //$order['inv_payee']     = $_POST['inv_payee'];
		/*增值税发票_删除_END_www.98ecshop.com*/
...
/*------------------------------------------------------ */
//-- start一键发货 增加 by www.98ecshop.com
/*------------------------------------------------------ */
...
/*------------------------------------------------------ */
//-- end一键发货 增加 by www.98ecshop.com
/*------------------------------------------------------ */
    /* 付款 */
    ...
    elseif (isset($_POST['assign']))
    {
        ...
        /* 操作成功 */
        $links[] = array('href' => 'order.php?act=list&' . list_link_postfix(), 'text' => $_LANG['01_order_list']);//supplier.98ecshop.com
        sys_msg($_LANG['act_ok'], 0, $links);
    }
    /* 订单删除 */
...
//    $action_note = $_REQUEST['action_note'];
    ...
    else
    {
        ...
        $smarty->assign('action_link', array('href' => 'order.php?act=list', 'text' => $_LANG['01_order_list']));//supplier.98ecshop.com
...
function order_list()
{
    ...
    if ($result === false)
    {
        ...
        if($_REQUEST['act'] == 'invoice_list' || (isset($_REQUEST['act_detail'])&&$_REQUEST['act_detail']=='invoice_query'))
        {
         ...
         /* 普通订单不显示虚拟团购订单 添加_START_www.98ecshop.com*/
        $where .= " AND o.extension_code != 'virtual_good'";
         /* 普通订单不显示虚拟团购订单 添加_END_www.98ecshop.com*/
		/*增值税发票_添加_END_www.98ecshop.com*/
		/* 代码增加_start   By www.ecshop68.com */
