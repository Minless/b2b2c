 ...
 * ============================================================================
 * $Author: 98ecshop.com $
 * $Id: users_export.php 17217 2013-01-19 06:29:08Z 98ecshop.com $
 */
...
elseif ($_REQUEST['act'] == 'act_export_excel')
{
	admin_priv('users_manage');
	 ...
	 $sql_swtshop_com = "select * from ". $GLOBALS['ecs']->table('user_rank');
	 $res_swtshop_com = $GLOBALS['db']->query($sql_swtshop_com);
	 while ($row_swtshop_com = $GLOBALS['db']-> fetchRow($res_swtshop_com))
	 {
		 if ($row_swtshop_com['special_rank'])
		 {
			$rank_list_www_com[$row_swtshop_com['rank_id']] = $row_swtshop_com['rank_name'];
		 }
		 else
		 {
			$rank_list_www_com[0][$row_swtshop_com['rank_id']] = array(
																							'rank_name' => $row_swtshop_com['rank_name'],
																							'min_points' => $row_swtshop_com['min_points'],
																							'max_points' => $row_swtshop_com['max_points']
																							);
		 }
	 }
