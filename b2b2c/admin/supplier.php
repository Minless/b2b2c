 ...
 * ============================================================================
 * $Author: swtshop $
 * $Id: suppliers.php 15013 2009-05-13 09:31:42Z swtshop $
 */
...
elseif ($_REQUEST['act']=='update')
{
  ...
  /* 代码增加_start  By  supplier.98ecshop.com */
  /* 取得供货商信息 */
  ...
  if(count($info)>0){
	...
	/* 代码增加_end  By  supplier.98ecshop.com */
...
elseif ($_REQUEST['act'] == 'delete'){
	...
	if($supplier_id > 0){
		...
		$supplier_info = array(
			...
			'delete FROM '.$ecs->table('supplier_rebate_log').' WHERE rebate_id in (SELECT rebate_id FROM '.$ecs->table('supplier_rebate').' WHERE supplier_id ='.$supplier_id.')',
