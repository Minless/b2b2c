...
elseif ($_REQUEST['act'] == 'top')
{
    ...
    // 代码修改   By  www.98ecshop.com Start
    // 获得管理员设置的菜单
...
{
    clear_all_files();
    clearhtml_all();  //代码增加   By  www.98ecshop.com
    sys_msg($_LANG['caches_cleared']);
}
//www.98ecshop.com手机缓存修改start
...
elseif ($_REQUEST['act'] == 'main')
{
    ...
    /*后台管理起始页_修改_START_www.98ecshop.com*/
...
//    " WHERE supplier_id=0 " . order_query_sql('finished');
    ...
    /*后台管理起始页_修改_END_www.98ecshop.com*/
...
elseif ($_REQUEST['act'] == 'main_api')
{
    ...
    ' WHERE is_delete = 0 AND is_alone_sale = 1 AND is_real = 1');
        ...
        $t = new transport;
        $api_comment = $t->request('http://api.ecshop.com/census.php', $apiget);
