...
/*优化了分类，去掉了之前开发的分类
if ($_REQUEST['act'] == 'get_catsel_swtshop')
{
...
$divid=$level+1;
$divid_next = $divid+1;
$arr['optionshtml'] = '<select name="cat_id_'. $divid .'" size=8 style="float:left;display:inline;margin-left:3px;" onchange="catsel_swtshop(this, '. $divid .')"><option value="0" style="background:#dce6f0;">请选择&nbsp;&nbsp;&nbsp;&nbsp;</option>'. $option_temp .'</select><div id="catsel'. $divid_next .'" style="float:left;display:inline;margin-left:3px;"></div>';
$arr['divid']    = $divid;
$arr['count'] =$j;
...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
	...
	// 代码增加_start_derek20150129admin_goods  www.swtshop.cn

	include_once(ROOT_PATH . '/includes/Pinyin.php');

	// 代码增加_end_derek20150129admin_goods  www.swtshop.cn
...
*/		
    ...
    /* 创建 html editor */
   create_html_editor('goods_desc', htmlspecialchars($goods['goods_desc'])); /* 修改 by www.swtshop.cn 百度编辑器 */
