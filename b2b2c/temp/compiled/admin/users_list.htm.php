...
?>
			<tr>
				...
				<td class="first-cell">
					...
					<!-- <?php endif; ?> -->
					<!-- <?php if ($this->_var['user']['talent'] == '1'): ?> -->
					<span style="margin-left: 5px;border: 1px #DD4C40 solid; background-color: #DD4C40; padding: 1px 2px 0px 2px; color: white; display: inline; border-radius: 2px;">
