...
?>
  ...
  <tr>
    ...
    <tr>
    <td class="label">达人状态:</td>
    <td>
      <select name="talent">
          <option value="0" <?php if ($this->_var['user']['talent'] == 0): ?> selected="selected"<?php endif; ?>>请选择审核状态</option>
            <option value="1" <?php if ($this->_var['user']['talent'] == 1): ?> selected="selected"<?php endif; ?>>申请通过</option>
            <option value="2" <?php if ($this->_var['user']['talent'] == 2): ?> selected="selected"<?php endif; ?>>申请中</option>
            <option value="3" <?php if ($this->_var['user']['talent'] == 3): ?> selected="selected"<?php endif; ?>>申请不通过</option> 
        </select>
    </td>
  </tr>
  <!-- #代码增加2014-12-23 by www.98ecshop.com  _end -->
