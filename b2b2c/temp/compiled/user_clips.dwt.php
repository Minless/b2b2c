...
<link rel="stylesheet" type="text/css" href="themes/swtshop_buy/css/user.css" />
...
?>
            ...
            <li>
              <ul class="img clearfix">
                <li> <a href="user.php?act=order_detail&order_id=<?php echo $this->_var['jiao']['order_id']; ?>" title="<?php echo $this->_var['jiao']['goods_name']; ?>" target="_blank"> 
                  ...
                  <img src="themes/swtshop_buy/images/cart-package.gif" border="0" title="<?php echo htmlspecialchars($this->_var['jiao']['goods_name']); ?>" /> 
                  <?php endif; ?> 
      ...
      <div class="middle cart">
        ...
        <script type="text/javascript" charset="utf-8" src="themes/swtshop_buy/js/easyscroll.js"></script>
...
?> 
		    ...
		    <?php else: ?> 
		    <img src="themes/swtshop_buy/images/user-store.jpg" alt="<?php echo $this->_var['guan']['supplier_name']; ?>" /> 
		    <?php endif; ?> 
		    </a> 
