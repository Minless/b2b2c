...
<link rel="stylesheet" type="text/css" href="themes/swtshop_buy/css/flow.css" />
...
<div class="header w990">
  <div class="mall-logo"><a href="./"><img src="themes/swtshop_buy/images/logo.gif" /></a> </div>
</div>
<div class="block"> 
...
?>
  ...
  <form id="formCart" name="formCart" method="post" action="flow.php">
    <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#ffffff" style=" border:#eeeeee 1px solid; border-top:#999999 2px solid;">
      <tr> 
...
?>
                <LI>
                  ...
                  <a href="javascript:addToCart(<?php echo $this->_var['goods']['id']; ?>)"><img src="themes/swtshop_buy/images/misc/lib/skin/i/adcart.gif" style="margin-top:5px;"/></a> </LI>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              </ul>
              <?php endif; ?> 
            </div>
  ...
  <div class="flowBox mod2"> <span class="lt"></span><span class="lb"></span><span class="rt"></span><span class="rb"></span>
    ...
    <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#eeeeee">
...
?>
          <ul class="clearfix">
            ...
            <li> <a href="<?php echo $this->_var['fittings']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['fittings']['goods_name']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['fittings']['short_name']); ?></a><br />
              ...
              <a href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)"><img src="themes/swtshop_buy/images/bnt_buy.gif" alt="<?php echo $this->_var['lang']['collect_to_flow']; ?>" /></a> </li>
          </ul>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
        </div>
      </form>
...
?><br />
          ...
          <tr>
            ...
            <td align="center" bgcolor="#ffffff"><input type="image" src="themes/swtshop_buy/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
          </tr>
          <?php endif; ?>
        </table>
...
?>
  ...
  <form action="flow.php" method="post" name="theForm" id="theForm" onsubmit="return checkOrderForm(this)">
    ...
    <div class="pre_box w">
      ...
      <table style="line-height:20px; border:#eeeeee 1px solid;" width="100%" align="center"  cellpadding="5" cellspacing="1" bgcolor="#ffffff" >
        <tr>
...
?>
        <tr>
          <td  colspan=20 style="background:#DDEFFF; border-bottom:1px solid #eeeeee; font-weight:bold;" > <?php echo $this->_var['goodsinfo']['0']['seller']; ?>
        </tr>
...
?> 
    ...
    <div class="pre_box w">
      ...
      <table style="line-height:30px; padding:5px; text-indent:5px; border:#eeeeee 1px solid; border-top:none;" width="100%" align="center"  cellpadding="5" cellspacing="1" bgcolor="#ffffff">
        <tr>
    ...
    <div class="pre_box w">
      ...
      <table align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#ffffff" id="shippingTable" style="border:#eeeeee 1px solid;">
        <tr>
...
?>
    ...
    <div class="pre_box w"  style=" display:none" >
      ...
      <table style=" display:none" width="100%" align="center"  cellpadding="5" cellspacing="1" bgcolor="#eeeeee" id="shippingTable">
        <tr>
...
?>
    ...
    <div class="pre_box w">
      ...
      <table style="line-height:20px; border:#eeeeee 1px solid;" width="100%" align="center"  cellpadding="5" cellspacing="1" bgcolor="#ffffff" id="paymentTable">
        <tr>
...
?> 
    ...
    <div class="pre_box w">
      ...
      <table style="line-height:20px; text-indent:5px; border:#eeeeee 1px solid;" width="100%" align="center"  cellpadding="5" cellspacing="1" bgcolor="#ffffff" id="packTable" >
        <tr>
...
?>
    ...
    <div class="pre_box w">
      ...
      <table style="line-height:20px; border:#eeeeee 1px solid; text-indent:5px;" width="100%" align="center"  cellpadding="5" cellspacing="1" bgcolor="#ffffff" id="cardTable">
        <tr>
...
?>
    ...
    <div class="pre_box w">
      ...
      <div align="center" style="margin:20px auto;">
        <input type="image" src="themes/swtshop_buy/images/jmpic/btn_done.gif" />
    ...
    <table width="99%" align="center" border="0" cellpadding="15" cellspacing="0" bgcolor="#fff" class="split_order" style="margin:20px auto;">
      <tr>
        <td style="padding-bottom:10px;"> <?php if ($this->_var['split_order']['sub_order_count'] > 1): ?>
          ...
          <?php endif; ?>
          <table width="100%" align=left cellpadding=0 cellspacing=0 bgcolor="#fff"  style="border:1px solid #eeeeee;border-bottom:none">
...
?>
            <tr >
              <td style="border-bottom:1px solid #eeeeee;padding-left:15px;background:#FAFAFA; width:445px;" height=30>订单号：<?php echo $this->_var['suborder']['order_sn']; ?></td>
              <td style="border-bottom:1px solid #eeeeee;background:#FAFAFA"><?php echo $this->_var['suborder']['pay_name']; ?>：<?php echo $this->_var['suborder']['order_amount_formated']; ?></td>
              <td style="border-bottom:1px solid #eeeeee;background:#FAFAFA"><?php echo $this->_var['suborder']['shipping_name']; ?>&nbsp;&nbsp;&nbsp;<?php echo $this->_var['order']['best_time']; ?></td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <?php if ($this->_var['virtual_card']): ?>
            <tr>
              <td colspan="3" style="border-bottom:1px solid #eeeeee;padding-left:15px;background:#FAFAFA; height:30px; text-align:left;">
...
?>
      ...
      <tr>
        <td align="center" style="padding-bottom:30px;"> <?php if ($this->_var['pay_online']): ?>
          ...
          <?php else: ?> <a href="user.php?act=order_list" class="enter-order-center">进入我的订单中心</a><?php endif; ?> </td>
      </tr>
    </table>
    <style>
...
<script type="text/javascript" src="themes/swtshop_buy/js/lib-v1.js"></script> 
