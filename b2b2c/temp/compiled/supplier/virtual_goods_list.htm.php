...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <?php endif; ?>
     <th>审批状态</th> 
     <th>商圈</th> 
    <th>标签</th> <!-- 晒单插件 增加 by www.swtshop.cn -->
...
?>
  <tr>
    ...
    <td align="center"><a href="goods_tag.php?act=list&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank">标签</a></td> <!-- 晒单插件 增加 by www.swtshop.cn -->
    <td align="center">
