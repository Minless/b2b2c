...
<!-- 修改 by www.swtshop.cn 百度编辑器 begin -->
...
<!-- 修改 by www.swtshop.cn 百度编辑器 end -->
...
<div class="tab-div">
    ...
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
		...
		<!--优化了分类，去掉了之前开发的分类
        <script>
		function catsel_swtshop(obj, level)
		{
			...
			Ajax.call('goods.php?act=get_catsel_swtshop&sjs='+Math.random(), "parentid=" + parentid + "&level=" + level, catsel_swtshop_response, "GET", "JSON");
			//alert(parentid);
		}
		function catsel_swtshop_response(res)
		{
