...
class cls_session
{
    ...
    function cls_session(&$db, $session_table, $session_data_table, $session_name = 'ECS_ID', $session_id = '')
    {
        ...
        else
        {
            ...
            setcookie($this->session_name, $this->session_id . $this->gen_session_key($this->session_id), time()+86400*7, $this->session_cookie_path, $this->session_cookie_domain, $this->session_cookie_secure); //代码修改 By  www.swtshop.cn  
        }
    ...
    function destroy_session()
    {
		...
		/* 注释掉下面这段代码或者直接删除_start   By  www.swtshop.cn */		
		...
		/* 注释掉下面这段代码或者直接删除_end   By  www.swtshop.cn */
