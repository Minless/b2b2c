...
/* 代码增加_end   By www.ecshop68.com */
 ...
 WHERE s.supplier_id=".$goods[supplier_id]." AND s.status=1";
		...
		// print_r($comment_tags);die;
    }
}

// $goods_id = $_SESSION['goods_id'];
// $res = get_my_comments($goods_id, $type = 0, $page = 1, $c_tag);
// var_dump($res);die;
//  $smarty->assign('comments',$res);
