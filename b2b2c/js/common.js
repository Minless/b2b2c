...
/* 组合购买__添加商品到购物车__Start By www.swtshop.cn */
...
/* 组合购买__添加商品到购物车__End By www.swtshop.cn */
...
/* 代码修改_start 整个替换掉即可 By www.swtshop.cn */
/*******************************************************************************
 * 评论的翻页函数
 */
...
function opencartDiv(price, name, pic, goods_brief, goods_id, total, number) {
	...
	// 生成层内内容
	html = '<div class=cardivfloat><span class=cartdivfloattitle>商品已成功添加到购物车！</span><a href=\'javascript:cancel_div()\' style="float:right;padding:0 26px 0 0;background:url(themes/swtshop_buy/images/ico_closebig1.gif) right center no-repeat;cursor:pointer;color:#ffffff;font-size:12px;" >关闭</a></div><div class="cartpopDiv"><div class="toptitle"><a href="goods.php?id=' + goods_id + '" class="pic"><img src=' + pic + ' width="98" height="98" style="border:#dddddd 1px solid; display:block;"/></a><p><font style="font-weight:bold">' + name + '</font>  <br>' + goods_brief + '<br>购买价格：<font style="color:#cc0000">' + price + '</font><br></p></div>';
	...
	html += "<div class=cartbntfloat ><a href='flow.php'><img src='themes/swtshop_buy/images/jsico1.gif'></a><a href=\'javascript:cancel_div()\'><img src='themes/swtshop_buy/images/goon_ico1.gif'></a></div>";
	html += '</div></div>';
